...
21 commands, 19 subjects, 12 stable error codes, 10 global flags, 27 Unicode scripts (31 font modules), 1074 tests, 79 sample PDFs in the baseline, 16 corpus files.
