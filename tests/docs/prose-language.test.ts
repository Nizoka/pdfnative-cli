...
// v1.5.0 — the English-only prose detector shared by verify-docs and this
...
describe('repository prose is English', () => {
    ...
    // what it does not read: the scripts, the sample shell scripts and the
    // tests. Sample JSON documents are demonstration content by nature
    // (a French-spacing sample IS French) and are out of scope, like
    ...
    it('scripts, sample shell scripts and tests carry no unmarked non-English line', () => {
        ...
        const files = [
            ...
            ...walk(join(ROOT, 'samples'), (n) => n.endsWith('.sh') || n.endsWith('.ps1') || n.endsWith('.js')),
