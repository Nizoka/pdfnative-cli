...
/**
 * v1.5.0 — `.claude/hooks/guard.mjs` is the PreToolUse hook that enforces
...
const DENIED: ReadonlyArray<readonly [command: string, what: RegExp]> = [
    ...
    ['npm unpublish pdfnative-cli@1.5.0', /unpublish/],
    ['npm deprecate pdfnative-cli@1.0.0 "old"', /deprecate/],
    ['npm dist-tag add pdfnative-cli@1.5.0 latest', /dist-tag/],
    ...
    ['gh api repos/Nizoka/pdfnative-cli/rulesets --method POST --input .github/rulesets/main.json', /gh api/],
    ['git push', /git push/],
...
const ALLOWED: readonly string[] = [
    ...
    'gh api repos/Nizoka/pdfnative-cli',
    'gh api repos/Nizoka/pdfnative-cli/releases --method GET',
    'git log --oneline -5',
