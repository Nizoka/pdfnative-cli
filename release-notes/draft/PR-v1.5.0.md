...
tests 600 → 1109 across 74 files.
...
- Tests: 1109 across 74 files (was 600) — `tests/helpers/cli-harness.ts`, per-feature
...
- `npm run test:coverage` → **1109 / 1109 passing across 74 files**; coverage
...
- `npx tsx scripts/gate.ts --publish --require-all` → **13 passed, 0 skipped in 308 s**
  (typecheck:all 24 s, lint 14 s, test:coverage 114 s — 1109 tests, 85.0 % stmts —, build
