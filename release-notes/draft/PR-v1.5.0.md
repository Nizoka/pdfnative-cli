...
tests 600 → 1074 across 73 files.
...
- Tests: 1074 across 73 files (was 600) — `tests/helpers/cli-harness.ts`, per-feature
...
- `npm run test:coverage` → **1074 / 1074 passing across 73 files**; coverage
...
- `npx tsx scripts/gate.ts --publish --require-all` → **13 passed, 0 skipped in 308 s**
  (typecheck:all 24 s, lint 14 s, test:coverage 114 s — 1074 tests, 85.0 % stmts —, build
