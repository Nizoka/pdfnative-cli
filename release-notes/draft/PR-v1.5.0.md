...
tests 600 → 1237 across 87 files.
...
- Tests: 1237 across 87 files (was 600) — `tests/helpers/cli-harness.ts`, per-feature
...
- `npm run test:coverage` → **1237 / 1237 passing across 87 files**; coverage
